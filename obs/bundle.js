...
function updateData(data){
    ...
    if (score1){
        score1.children[0].innerText = data["player"][0]["score"].filter(value => value === true).length
    }
    if (score2){
        score2.children[0].innerText = data["player"][1]["score"].filter(value => value === true).length
    }
    if (round){
