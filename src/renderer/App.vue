...
<template>
    <div class="flex flex-col h-100vh">
        ...
        <div
            class="flex-grow bg-sunnyshore-beach-primary rounded-xl mx-4 grid grid-cols-3 gap-4 p-6 shadow-xl"
        >
            <div class="p-4 bg-sunnyshore-beach-secondary rounded-xl shadow-md">
                ...
                <div v-if="key == 'player'" class="mb-6">
                    <label
                        for="player1pronouns"
                        class="ml-3 text-sm text-gray-700 block mb-1 font-medium"
                    >
                    ...
                    <input
                        v-model="data[key][0]['pronouns']"
                        type="text"
                        name="player1pronouns"
                        id="player1pronouns"
                        class="m-0 bg-gray-100 border border-gray-200 rounded py-1 px-3 w-full block focus:ring-2 focus:outline-none focus:ring-sunnyshore-pink-light focus:border-sunnyshore-pink-light text-gray-700"
                ...
                <div class="mb-6">
                    <div v-if="key == 'player'">
                        ...
                        <input
                            @click="checkbox_fix(0, 0)"
                            v-model="data.player[0].score[0]"
                            type="checkbox"
                            name="player1score"
                            id="player1score"
                            class="w-5 h-5 mx-4"
                        ...
                        />
                        <input
                            @click="checkbox_fix(0, 1)"
                            v-model="data.player[0].score[1]"
                            type="checkbox"
                            name="player1score"
                            id="player1score"
                            class="mx-4 w-5 h-5"
                        ...
                        />
                        <input
                            @click="checkbox_fix(0, 2)"
                            v-model="data.player[0].score[2]"
                            type="checkbox"
                            name="player1score"
                            id="player1score"
                            class="mx-4 w-5 h-5"
            ...
            <div class="p-4 bg-sunnyshore-beach-secondary rounded-xl shadow-md">
                ...
                <div class="mb-2 mt-10">
                    <button
                        ...
                        :class="
                            mode == 0
                                ? 'hover:bg-gray-400 bg-gray-400 cursor-default border-gray-400'
                                : ''
                        "
                        class="py-1.5 block px-4 w-full bg-gray-50 border active:bg-gray-400 font-medium border-gray-200 text-gray-900 rounded-lg hover:bg-gray-100 disabled:opacity-50"
                    >
        ...
        <path d="M0 0h24v24H0z" fill="none"/>
            ...
            <div class="p-4 bg-sunnyshore-beach-secondary rounded-xl shadow-md">
                ...
                <div v-if="key == 'player'" class="mb-6">
                    ...
                    <input
                        v-model="data[key][1]['pronouns']"
                        type="text"
                        name="player2pronouns"
                        id="player2pronouns"
                        class="m-0 bg-gray-100 border border-gray-200 rounded py-1 px-3 w-full block focus:ring-2 focus:outline-none focus:ring-sunnyshore-pink-light focus:border-sunnyshore-pink-light text-gray-700"
                        placeholder="Pronouns..."
                    />
